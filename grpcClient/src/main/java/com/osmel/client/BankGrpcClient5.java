...
public class BankGrpcClient5 {
    public static void main(String[] args) throws IOException {
        ...
        Ebank.ConvertCurrencyRequest request = Ebank.ConvertCurrencyRequest.newBuilder()
                ...
                .setCurrencyTo("EUR")
                .build();
        StreamObserver<Ebank.ConvertCurrencyRequest> fullStream = asyncStub
                .fullStream(new StreamObserver<Ebank.ConvertCurrencyResponse>() {
                    @Override
        ...
        timer.schedule(
                new TimerTask() {
                    ...
                    @Override
                    public void run() {
                        fullStream.onNext(Ebank.ConvertCurrencyRequest.newBuilder().setAmount(Math.random()*10000).build());
                        counter++;
